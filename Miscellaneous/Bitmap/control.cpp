...
void AddControl(HWND hwnd)
{
	...
	HWND hBut = CreateWindowW(L"button", NULL , WS_VISIBLE | WS_CHILD | WS_BORDER | BS_BITMAP, 150, 140, 98, 38, hwnd,
	...
	hLogo = CreateWindowW(L"static", NULL , WS_VISIBLE | WS_CHILD | SS_BITMAP, 350, 60, 100, 100, hwnd,
					NULL, NULL, NULL);
...
void LoadImage()
{
	hLogoImage = (HBITMAP)LoadImageW(NULL, L"image.bmp", IMAGE_BITMAP, 100, 100, LR_LOADFROMFILE);
	hGenerateImage =  (HBITMAP)LoadImageW(NULL, L"submit.bmp", IMAGE_BITMAP, 100, 108, LR_LOADFROMFILE);
